...
export function* onCheckUserSession() {
  yield takeLatest(userConstType.CHECK_USER_SESSION, isUserAuthenticated);
}

export function* onSignOutStart() {
  yield takeLatest(userConstType.SIGN_OUT_START, signOut);
}

export function* onSignUpStart() {
  yield takeLatest(userConstType.SIGN_UP_START, signUp);
}

export function* onSignUpSuccess() {
  yield takeLatest(userConstType.SIGN_UP_SUCCESS, signInAfterSignUp);
}
